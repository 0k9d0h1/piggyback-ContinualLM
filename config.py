...
def parseing_posttrain():
    ...
    parser.add_argument("--baseline",
                        ...
                        choices=["dga", "das", "adapter_hat", "adapter_bcl", "adapter_one", "adapter_classic", "prompt_one", "distill", "derpp", "ewc", "ncl", "one", "piggyback", "lora", "lora_piggyback", "piggyback_minus_one"])
